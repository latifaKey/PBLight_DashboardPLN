...
<head>
  ...
  <title>Dashboard Kinerja - Master Admin</title>
  ...
  <div class="container">
    ...
    <aside class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li>
            <a href="{{ route('dashboard.master') }}" class="{{ request()->routeIs('dashboard.master') ? 'active' : '' }}">              <img src="/images/dashboard.png" /> Dashboard
            </a>
          </li>
