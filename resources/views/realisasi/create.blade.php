...
<div class="dashboard-content">
    ...
    <div class="page-header">
        <div>
            ...
            <div class="page-header-subtitle">
                Masukkan data realisasi kinerja untuk periode:
                {{ \Carbon\Carbon::create(null, $bulan, 1)->locale('id')->monthName }} {{ $tahun }}
    ...
    <div class="form-card">
        ...
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="info-row">
                            ...
                            <div class="info-value">{{ ucfirst($periodeTipe) }}</div>
                        </div>
                    </div>
                </div>
            ...
            <form id="formRealisasi" method="POST" action="{{ route('realisasi.store') }}">
                @csrf

                <input type="hidden" name="indikator_id" value="{{ $indikator->id }}">
                <input type="hidden" name="tahun" value="{{ $tahun }}">
                <input type="hidden" name="bulan" value="{{ $bulan }}">
                <input type="hidden" name="periode_tipe" value="{{ $periodeTipe }}">
                @if($periodeTipe == 'mingguan')
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="number" step="0.01" class="form-control @error('nilai') is-invalid @enderror"
                           id="nilai" name="nilai" value="{{ old('nilai', $nilai->nilai ?? '') }}" required>
                    @error('nilai')
                ...
                <div class="form-group mb-4">
                    ...
                    <textarea class="form-control @error('keterangan') is-invalid @enderror"
                              id="keterangan" name="keterangan" rows="3">{{ old('keterangan', $nilai->keterangan ?? '') }}</textarea>
                    @error('keterangan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <small class="form-text text-muted">
